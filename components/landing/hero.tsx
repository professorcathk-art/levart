  ...
  return (
    <section className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center overflow-hidden bg-[#FAF6F0] px-4 py-16 md:py-24">
      ...
      <div className="relative z-10 mx-auto w-full max-w-6xl">
        ...
        >
          <p className="mb-6 inline-flex items-center gap-2 rounded-full border border-white/60 bg-white/70 px-4 py-1.5 font-mono text-xs font-semibold uppercase tracking-[0.22em] text-[#E07A5F] shadow-[0_8px_24px_rgba(224,122,95,0.12)] backdrop-blur-md">
            <PawMark size={16} />
            {t('heroEyebrow')}
          </p>
          <h1 className="text-5xl font-extrabold leading-[1.05] tracking-tight text-[#2B2D42] md:text-7xl">
            {t('heroTitle1')}
